...
(function ($) {
  ...
  switch(lang) {
    case 'us':
      NoSelected = 'No Selected Item';
      NoResultsText = 'No results matched';
      selAllText = 'Mark All';
      deselAllText = 'Deselect All';
      doneBtnText ='Close';
      EntrySearch = 'Search';
      break;
    case 'br':
      NoSelected = 'Nenhum Item Selecionado';
      NoResultsText = 'Nenhum Resultado Encontrado';
      selAllText = 'Marcar Todos';        
      deselAllText ='Desmarcar Todos';
      doneBtnText = 'Fechar';
      EntrySearch = 'Pesquisar';
      break;
    case 'es':
      NoSelected = 'Ningún Elemento Seleccionado'
      NoResultsText = 'No se encontraron resultados';    
      selAllText = 'Marcar Todos';
      deselAllText ='Deseleccionar Todos';
      doneBtnText = 'Cerrar';
      EntrySearch = 'Buscar';
      break;
    default:
  ...
  Selectpicker.DEFAULTS = {
    noneSelectedText: NoSelected,
    noneResultsText: NoResultsText + ' {0}',
    ...
    selectAllText: selAllText,
    deselectAllText: deselAllText,
    doneButton: false,
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      (null === this.options.liveSearchPlaceholder ? '' : ' placeholder="'+ EntrySearch +'"') + ' role="textbox" aria-label="'+ EntrySearch +'">' +
      '</div>'
          : '';
