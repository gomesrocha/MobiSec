                                        ...
                                        <form role="form" method="post" name="cadastro_form">
                                                ...
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        <label class="fancy-checkbox element-left">
                                                            <input id="analisepermi1" type="checkbox" name="analisepermi1" value="1">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        <label class="fancy-checkbox element-left">
                                                            <input id="analisepermi2" type="checkbox" name="analisepermi2" value="1">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        <label class="fancy-checkbox element-left">
                                                            <input id="analisepermi3" type="checkbox" name="analisepermi3" value="1">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        <label class="fancy-checkbox element-left">
                                                            <input id="analisepermi4" type="checkbox" name="analisepermi4" value="1">
